...
{
$user=$_POST["username"];
$sql = "SELECT username, password FROM students WHERE username='".$_POST["username"]."' " ;
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
         if($row["username"]==$_POST["username"] && $row["password"]==$_POST["login-password"]) // - Password: ". $row["password"]. "<br>";
             header("location:/ProjectSchool/student_dashboard.php");
        else{
		...
		<div class="sign-up-container">
			...
			<div class="signup-align">
				<form name="login" action="" method="post"
					...
					<div class="signup-heading">Student Login</div>
